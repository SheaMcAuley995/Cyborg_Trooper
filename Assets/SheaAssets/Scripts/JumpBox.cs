...
public class JumpBox : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && !isHooking)
        {
            ...
            hookEnd =  baby.transform.position + (Vector3)(mouseClick.normalized * hookLength);
    ...
    {
       Collider2D c = hookObj.GetComponent<BoxCollider2D>();
        float t = 0;
        while(t < 1)//whatever parameter you want
        {
            ...
            hookObj.transform.position = Vector3.Lerp(hookStart, hookEnd, t);
            Debug.Log(t);
